...
const SuggestionProducts = ({ category, heading }) => {
  ...
  return (
    <div className="contianer mx-auto px-4 my-4 h-full relative  ">
      ...
      <div className=" grid grid-cols-[repeat(auto-fit,minmax(300px,340px))] mt-4 justify-center  md:gap-6 items-center overflow-y-hidden  overflow-x-scroll scroll-smooth no-scrollbar transition-all ">
        {loading
